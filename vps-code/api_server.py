...
# daily_messages functions removed — using database.py rolling 24h window instead
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    # Additional origins for production
...
async def auth_telegram(req: TelegramAuthRequest):
    ...
    is_maint = db_is_maintenance_mode()
    ...
    return {
        ...
        "maintenance": is_maint and not is_admin_user,
